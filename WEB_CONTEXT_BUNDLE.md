...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-251-erd-s-problem-251-56e7ee39-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-251"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-251-erd-s-problem-251-56e7ee39-v1",
      "problem_contract_sha256": "814a727f1e15d259be14229d2e6a847b85649c671263e2951dcc5311909c3a43",
      "problem_id": "problem:um-ep-251-erd-s-problem-251-56e7ee39",
      "route_id": "route:um-ep-251-erd-s-problem-251-56e7ee39-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-251-erd-s-problem-251-56e7ee39-source-fidelity-01",
      "graph_id": "graph:um-ep-251-erd-s-problem-251-56e7ee39-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-251-erd-s-problem-251-56e7ee39-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-251-erd-s-problem-251-56e7ee39-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Is $ \\sum \\frac{p_n}{2^n} $ irrational? (Here $p_n$ is the $n$th prime.)"
          },
          "statement_sha256": "5288353eb5f4d5b556b227679ee17fd611d2825cca875cb62ac87923a6015c07"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-251-erd-s-problem-251-56e7ee39-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-251-erd-s-problem-251-56e7ee39-root",
      "route_id": "route:um-ep-251-erd-s-problem-251-56e7ee39-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-251-cf809dc7741a",
        "url": "https://www.unsolvedmath.com/problems/EP-251"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
